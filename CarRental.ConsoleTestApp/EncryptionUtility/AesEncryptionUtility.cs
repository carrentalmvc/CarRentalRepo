...
namespace CarRental.ConsoleTestApp
{
    ...
    ///You may want to modify the code so that it automatically update the web/App configs in production environment.The generated base64 encoded strings will vary from machine to machine.This sould be done separatey in each servers
    /// </summary>
    internal class AesEncryptionUtility
    {
